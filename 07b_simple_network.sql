...
BEGIN
  ...
  -- Insert reachpoints
  INSERT INTO qgep_od.vw_network_node_simple(node_type, ne_id, rp_id, geom)
  SELECT
    'reachpoint',
  ...
  JOIN qgep_od.vw_network_node_simple as n1 ON n1.rp_id = rp_obj_id
  JOIN qgep_od.vw_network_node_simple as n2 ON n2.ne_id = wwne_id
